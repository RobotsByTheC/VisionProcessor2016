...
class ContinuousAngleTracker {
    ...
    public void nextAngle(float newAngle) {
        ...
        /*
         * If the first received sample is negative, ensure that the zero
         * crossing count is decremented.
         */
        ...
        /*
         * Calculate delta angle, adjusting appropriately if the current sample
         * crossed the -180/180 point.
         */
        ...
        /*
         * If a zero crossing occurred, increment/decrement the zero crossing
         * count appropriately.
         */
        if (!bottom_crossing) {
            if (delta_angle < 0.0f) {
